...
<c:set var="phoneNum" value="${user.u_tel}" />
<c:set var="splitNum" value="${fn:split(phoneNum, '-')}" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<form action="user-edit-process.do" name="user" method="post">
			<input type="hidden" name="u_idx" value="${user.u_idx}">
	   		...
	   		<p> 연락처 : <input type="text" maxlength="4" size="4" name="edit_tel1" value="${splitNum[0]}"> -
	   				   <input type="text" maxlength="4" size="4" name="edit_tel2" value="${splitNum[1]}"> -
	   				   <input type="text" maxlength="4" size="4" name="edit_tel3" value="${splitNum[2]}"> 
	   		</p>
